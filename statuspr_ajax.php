...
//    $qrytmp = "SELECT * FROM status ORDER BY id_status DESC";
    $qrytmp = "select * from (select * from status where id_user='$id' or id_user_tujuan='$id' order by id_status desc) where ROWNUM <= 10";
...
?>
    ...
    <div class="span10">
        ...
        if ($id1==$id2){
            ?>
            <strong><a href="profilpr.php?namauser=<?=$nama2;?>"	><?php echo $nama2; ?></a></strong><br>
            <?
        }
        elseif($id1!=$id2){
            ?>
            <strong><a href="profilpr.php?namauser=<?=$nama2;?>"	><?php echo $nama2; ?></a>
                <i class="icon-play"></i>
