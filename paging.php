...
if(isset($_POST['idakhir']))
{
    ...
    $query="select * from (select * from status where id_user='$id_user' or id_user_tujuan='$id_user' order by id_status desc) where ROWNUM <= 7 and id_status < '$idakhir'";
...
<?
            if ($id1==$id2){
                ?>
                <strong><a href="profilpr.php?namauser=<?=$nama;?>"	><?php echo $nama; ?></a></strong><br>
                <?
            }
            elseif($id1!=$id2){
                if($id1==$id_user){
                    ?>
                    <strong><a href="profilpr.php?namauser=<?=$nama4;?>"	><?php echo $nama4; ?></a>
                        <i class="icon-play"></i>
                        <a href="profilpr.php?namauser=<?=$nama3;?>"	><?php echo $nama3; ?></a></strong><br>
                    <?
                }
                elseif($id2==$id_user){
                    ?>
            ...
            <div class="accordion-inner">
                <div class="row-fluid">
                    <div id="commentload<?php echo $id_status;?>">
                        <?php include ('buka_komentarpr.php'); ?>
                    </div>
